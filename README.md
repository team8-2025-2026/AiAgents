...
flowchart LR
    subgraph A[Участник 1]
        A1[Анализ требований]
        A2[Проектирование решения]
        A3[Реализация части функциональности]
    end

    subgraph B[Участник 2]
        B1[Планирование задач]
        B2[Реализация части функциональности]
        B3[Тестирование]
    end

    subgraph C[Участник 3]
        C1[Подготовка окружения]
        C2[Интеграция изменений]
        C3[Документация]
    end
